...
const LowonganDetail = () => {
    ...
    return(
        ...
        <div className="max-y-sm my-10 lg:mx-36 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <img className="rounded-full w-56 mx-auto mt-10 mb-10" src={dataJob?.company_image_url} alt="" />
        <div className="p-5 my-10 mx-10 mb-5">           
            <h5 className="mb-2 text-2xl tracking-tight text-black dark:text-white">{dataJob?.title}</h5>
            ...
            <p className="mb-3 font-normal text-gray-400 text-xl dark:text-gray-400">{dataJob?.company_city}</p>
            ...
            <p className="mx-4 text-xl font-normal">
                {dataJob?.job_tenure}, {dataJob?.job_type}
            </p>            
            </div>
            ...
            <p className="mx-4 text-xl font-normal">
                {convertToRupiah(dataJob?.salary_min + "")}    -    {convertToRupiah(dataJob?.salary_max + "")}
            </p>            
            </div>
            ...
            <span className="text-xl w-full px-10 py-4 text-sm rounded-xl text-white bg-teal-300">
                {handleStatus(dataJob?.job_status)}
            </span>
            </div>
        </div>
        </div> 
        <div className="max-y-sm mb-10 lg:mx-36 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <p className="mb-3 font-normal text-xl text-gray-700 dark:text-gray-400">{dataJob?.job_qualification}</p> 
            </div>
        </div>   
        <div className="max-y-sm mb-10 lg:mx-36 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <div className="p-10">
            <p className="mb-3 font-normal text-center text-xl dark:text-gray-400">Company Description</p>
            <p className="mb-3 font-normal text-xl text-gray-700 dark:text-gray-400">{dataJob?.job_description}</p> 
            </div>
        </div>   
        </>
    )
