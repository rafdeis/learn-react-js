...
const Navigation = () => {
    ...
    return(
        ...
        <>
        <li>
        <Link to={'/login'} type="button" className="text-white bg-teal-300 hover:bg-blue-400 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Login</Link>
        </li>
        </>
        }
        {Cookies.get('token')&&
